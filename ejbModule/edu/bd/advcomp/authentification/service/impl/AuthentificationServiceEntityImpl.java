 ...
 * 
 * import edu.bd.advcomp.authentification.entity.Utilisateur; import
 * edu.bd.advcomp.authentification.service.AuthentificationService; import
 * edu.bd.advcomp.authentification.service.UtilisateurService;
 * 
 *//**
...
/*
 * 
 * @Stateless public class AuthentificationServiceEntityImpl implements
 ...
 *//**
    ...
    * @return
    *//*
       * @Override public Boolean authentifier(String login, String password) { try {
       * Utilisateur utilisateur = utilisateurService.obtenirUtilisateur(login);
       * return utilisateur != null && password != null &&
